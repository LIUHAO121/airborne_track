...
import sys
sys.path.append("core/metrics/airborne_metrics")
...
def add_flags(parser):
    ...
    parser.add_argument('--dataset-folder', '-d',
                            # required=True,
                            default="data/part3_val",
                        help='Name of the folder with dataset ground truth')
    parser.add_argument('--results-folder', '-r', 
                            # required=True,
                            default="data/results/res18_e35_2048_fr3sd2_ml0_tl0_s0.5_ts0.5_fa0.05_single_MaxScoreAndArea",
